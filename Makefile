...
ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --private-key $(TENDERLY_PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif

ifeq ($(findstring --network tenderly,$(ARGS)),--network tenderly)
	NETWORK_ARGS := --rpc-url $(TENDERLY_RPC_URL) --private-key $(TENDERLY_PRIVATE_KEY) --broadcast -vvvv
endif
